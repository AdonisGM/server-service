...
create table t_MGT_INFO(
	pk_mgt_info				varchar2(50)	default sys_guid() not null,
...
create table t_MGT_MODULE(
	pk_mgt_module			varchar2(50)	default sys_guid() not null,
	c_username				varchar2(50)	not null,
...
create table t_MGT_MODULE_QUESTION(
	pk_mgt_module_question	varchar2(50)	default sys_guid() not null,
